...
const TieMeKangarooDownSport = () => (
    <div>
    There&apos;s an old Australian stockman lying, dying. He gets himself up<br/>
    onto one elbow and &apos;e turns to his mates, who are all gathered around and &apos;e says:<br/>
    <br/>
    <br/>
    ...
    Ah, don&apos;t go acting the fool, Curl<br/>
    Just keep me cockatoo cool<br/>
    Altogether now!<br/>
    <br/>
    (CHORUS)<br/>
    <br/>
    &apos;n&apos; take me koala back, Jack<br/>
    ...
    (CHORUS)<br/>
    <br/>
    Let me abos go loose, Lew<br/>
    Let me abos go loose<br/>
    They&apos;re of no further use, Lew<br/>
    So let me abos go loose<br/>
    Altogether now!<br/>
    <br/>
    (CHORUS)<br/>
    <br/>
    And mind me platypus duck, Bill<br/>
    Mind me platypus duck<br/>
    Ah, don&apos;t let &apos;im go running amok, Bill<br/>
    Just mind me platypus duck<br/>
    Altogether now!<br/>
    <br/>
    (CHORUS)<br/>
    <br/>
    ...
    Ah, like, keep playin&apos; &apos;til I shoot thru, Blue<br/>
    Play your didgeridoo<br/>
    Altogether now!<br/>
    <br/>
    (CHORUS)<br/>
    ...
    And that&apos;s it hangin&apos; on the shed!!<br/>
    Altogether now!<br/>
    <br/>
    (CHORUS)
    </div>
